    ...
    ui(new Ui::SettingsDialog)
{
    ...
    connect(ui->applyButton, &QPushButton::clicked,
            this, &SettingsDialog::apply);//确认按钮的信号和槽
    connect(ui->serialPortInfoListBox, static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
            this, &SettingsDialog::showPortInfo);//串口号窗口点击，改变显示信息
    connect(ui->baudRateBox,  static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
            this, &SettingsDialog::checkCustomBaudRatePolicy);//波特率选择窗口点击
    connect(ui->serialPortInfoListBox,  static_cast<void (QComboBox::*)(int)>(&QComboBox::currentIndexChanged),
            this, &SettingsDialog::checkCustomDevicePathPolicy);//串口号窗口点击custom时候，检测信息合理性
...
void SettingsDialog::fillPortsParameters()
{
    ...
    ui->baudRateBox->setCurrentIndex(3);//默认选择波特率为115200
//    ui->baudRateBox->addItem(tr("Custom"));
    ...
    ui->dataBitsBox->setCurrentIndex(3);//默认选择数据为8位
